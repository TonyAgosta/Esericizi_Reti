...
public class Utenti extends Thread {
    ...
    private int access;
    private int indextesista; // indice del computer usato dai tesisti
    ...
    public void run() {
        ...
        for (int i = 0; i < access; i++) {
            ...
            if (this.priority == 1) {
                ...
                lab.lockcoda.unlock();
                try {
                    Thread.sleep((long) Math.random() * 5000); // uso la sleep per simulare l'utilizzo del computer
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
            ...
            // professore
                ...
                try {
                    Thread.sleep((long) Math.random() * 6000);// sleep per simulare l'utilizzo del computer
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
